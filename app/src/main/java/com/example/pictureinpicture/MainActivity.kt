...
class MainActivity : ComponentActivity() {
    ...
    private val isPipAvailable by lazy {
    ...
    private fun updatePipBounds(): PictureInPictureParams? {
                    ...
                    listOf(
                        RemoteAction(
                            ...
                            PendingIntent.getBroadcast(
                                applicationContext,
                                0,
                                Intent(applicationContext, CustomReceiver::class.java),
